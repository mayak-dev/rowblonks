...
int Lua::Api::addLocalCoreScript(lua_State* L)
{
    ...
    (reinterpret_cast<void* (__thiscall*)(void*, RBX::CoreScript*, bool)>(0x0061AF40))(new char[8], coreScript, false);
...
int Lua::Api::addLocalStarterScript(lua_State* L)
{
    ...
    (reinterpret_cast<void* (__thiscall*)(void*, RBX::StarterScript*, bool)>(0x0061AE90))(new char[8], starterScript, false);
...
int Lua::Api::registerLocalLibrary(lua_State* L)
{
    ...
    (reinterpret_cast<void* (__thiscall*)(void*, RBX::Script*, bool)>(0x00428EE0))(new char[8], script, false);
